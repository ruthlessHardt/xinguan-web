# 基于动态规划的新冠物资管理系统的设计与实现(开发中)

基于数据可视化的新冠物资管理系统的设计与实现
@Author:liwentao

![image](https://s3.jpg.cm/2021/02/28/zMYT4.png)
...
管理所有。负责处理涉及高权限的事务。例如处理一级管理者的事务、重置一级管理者账号或密码。操作日志。
